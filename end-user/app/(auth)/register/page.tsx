    ...
    <div className="min-h-screen bg-background flex">
          ...
          <div className="w-full max-w-md space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-muted-foreground text-pretty">
                Tạo tài khoản để bắt đầu sử dụng CampRent.
              </p>
            </div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <div className="absolute inset-0">
          <Image
            src="https://images.unsplash.com/photo-1478131143081-80f7f84ca84d?q=80&w=2600"
        ...
        <div className="absolute bottom-0 left-0 right-0 p-12 text-white">
          <h2 className="text-4xl font-bold italic mb-4">
            Tham gia cùng CampRent
          </h2>
          <p className="text-lg text-white/80">
            Tạo tài khoản ngay để khám phá hàng ngàn vật dụng và thiết bị cắm trại cho chuyến đi của bạn.
          </p>
        </div>
      </div>
    </div>
