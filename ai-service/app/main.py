...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting CampRent AI Service...")
    ...
    logger.info("Shutting down CampRent AI Service...")


app = FastAPI(
    title="CampRent AI Chatbot Service",
    description="AI-powered outdoor gear consultation chatbot using LangChain + RAG for CampRent platform",
    version="1.0.0",
    lifespan=lifespan
)
...
async def ask(request: ChatRequest):
    """
    Chat with AI about outdoor/camping products and orders.
