...
const getDefaultEvidenceType = (status: OrderStatus): OrderEvidenceType => {
  switch (status) {
    ...
    default:
      return OrderEvidenceType.SEND_PACKAGE; // Default for shop
  }
};
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid max-w-sm items-center gap-1.5">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value={OrderEvidenceType.SEND_PACKAGE}>
                        Shop đã gửi hàng
                      </SelectItem>
                      <SelectItem value={OrderEvidenceType.RECEIVE_RETURN}>
                        Shop đã nhận trả
                      </SelectItem>
                    </SelectContent>
                  </Select>
